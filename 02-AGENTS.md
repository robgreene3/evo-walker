...
- Package manager and version: [verified]
- Runtime versions: [verified]
- Architecture boundaries: [verified component -> responsibility]
- Install: [verified command]
- Run: [verified command]
- Format: [verified command]
- Lint: [verified command]
- Typecheck: [verified command]
- Targeted tests: [verified command/pattern]
- Full verification: [verified command]
- Benchmarks: [verified command]
- Build/package: [verified command]
- Generated or protected paths: [verified paths]
- Supported browsers/platforms: [verified]
- Project-specific done gate: [verified release criteria]
